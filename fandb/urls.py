...
from fandb.views import RegistrationView, AddBookView, IssueBookView,BookListView,StudentListView,LoginView,LogoutView,LateSubmissionView,FeesPaidView
...
urlpatterns = [
    ...
    url(r'late/fees',LateSubmissionView.as_view()),
